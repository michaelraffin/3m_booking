...
export default function Home() {
    ...
    try {
      if (date.from != undefined && eventType === "Multiple") {
        return (
          <>
            <div className={`${classDetails}`}>
              <input
                className="rounded-md font-md w-40 text-xs "
                disabled={true}
                value={`From : ${moment(date.from).format("LL")}`}
              />
              <input
                className="rounded-md font-md w-40 text-xs "
                disabled={true}
                value={`To : ${moment(date.to).format("LL")}`}
              />
        ...
        return (
          <div className={`${classDetails}`}>
            <input
              className="w-48   text-xs mt-2"
              disabled={true}
              value={`Event date : ${moment(date.from).format("LL")}`}
            />
          </div>
        );
      }
          ...
          if (item?.price != 0) {
            items.push(
              <a
                ...
                onClick={() => didTappedService(item)}
              >
                <article
                  className={`rounded-lg border ${isActive ? " border-gray-300 bg-black p-6" : " border-gray-300 bg-white p-6"} hover:shadow-lg`}
                >
                  <div>
                    <p
                    ...
                    <p
                      className={`text-2xl font-medium ${isActive ? "text-white" : "text-black"}`}
                    >
                  ...
                  <div className="mt-1 flex gap-1 text-green-400">
                    ...
                    <p className="flex gap-2 text-xs">
                      ...
                      <span
                        className={`text-xs ${isActive ? "text-white" : "text-black"}`}
                      >
                        {" "}
                        {item.subtitle}{" "}
                      </span>
      ...
      if (isEmpty) {
        return (
          <div ref={emptyRef} className="text-center">
            <img
              src="https://cdn.dribbble.com/users/183518/screenshots/2581188/media/ba6518c3a42da81603792166b8fe188f.png?resize=800x600&vertical=center"
              width={"500"}
              height={200}
        ...
        <div className="lg:grid flex flex-col lg:grid-rows-3 grid-flow-col gap-4 mt-60  ">
          ...
          <div className="col-span-2 ... lg:mt-0 mt-10 ml-20">
            ...
            <Tabs
              ...
              onValueChange={(e) => selectedEventType(e)}
            >
              <TabsList className=" rounded-full">
                <TabsTrigger value="Single" className=" rounded-full text-xs">
                  One Day Event
                </TabsTrigger>
                <TabsTrigger value="Multiple" className=" rounded-full text-xs">
                  Multiple Day Event
                </TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="Multiple">
                <p className="text-xs text-gray-700 mt-10">
                  Selected days: ({daysCounter()}){" "}
                  {displayFirstLastDate("flex flex-col gap-2 mt-4 ...")}
                </p>
              </TabsContent>
            </Tabs>
          ...
          <div className="row-span-2 col-span-2  ml-20 ...">
            ...
            <Button
              ...
              variant="outline"
              className=" rounded-full text-xs hover:shadow-lg bg-black text-white mt-10"
            >
              {status ? "Searching..." : "Search available slot"}
            </Button>
            ...
            <div className="row-span-2 col-span-2 ...">
              <h1>
                {new Intl.NumberFormat("en-PH", {
                  style: "currency",
                  currency: "PHP",
                }).format(daysCounter() * selectedService.price)}
              </h1>
              <Button
                disabled={status}
                onClick={() =>
                ...
                variant="outline"
                className=" rounded-full hover:shadow-lg bg-black text-white mt-10"
              >
            ...
            <div className="flex justify-between">
              <span className="">
                ...
                <span className="text-xs" style={{ fontSize: 11 }}>
                  {selectedService.discountedTitle}
                </span>
              </span>
              <br />
              ...
              <span className="text-red-500">
                ...
                {new Intl.NumberFormat("en-PH", {
                  style: "currency",
                  currency: "PHP",
                }).format(selectedService.discountedValue)}
              </span>
            </div>
          </div>
          <div className="pt-4 space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {new Intl.NumberFormat("en-PH", {
                    ...
                    daysCounter() *
                      (selectedService.price - selectedService.discountedValue),
                  )}
                </span>
              </div>
      ...
      <Accordion type="single" collapsible className="w-full">
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="text-xs">
            <img
              src="https://localflowershop.sgp1.digitaloceanspaces.com/product/1705113012149-scanPay.png"
              width={"200"}
              height={200}
              className="hover:shadow-lg rounded-lg ml-4 mb-2"
            />
            <img
              src="https://localflowershop.sgp1.digitaloceanspaces.com/product/1705113100668-PYMY%20LOOKEE%20%281%29.png"
              width={"200"}
              height={200}
              className="hover:shadow-lg rounded-lg ml-4 mb-2"
            />
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger disabled={true} className="text-gray-200">
            Installment
          </AccordionTrigger>
          <AccordionContent className="text-xs">
            <img
              src="https://www.bworldonline.com/wp-content/uploads/2022/09/billease-logo.jpg"
              width={"200"}
              height={200}
              className="hover:shadow-lg rounded-lg ml-4"
            />
            <img
              src="https://assets-global.website-files.com/64624bb008de2f11dbf1f3a1/6465f9263eb94044a3743277_HitPay_Blue-min.svg"
              width={"200"}
              height={200}
              className="hover:shadow-lg rounded-lg ml-4"
            />
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdYezi5IEhWjNsRSEP9EdEDt2U9sN3bei49Tk_LRzBukQj3fIjjghemVMPrjjbQMtsiOo&usqp=CAU"
              width={"200"}
              height={100}
              className="hover:shadow-lg rounded-lg ml-4"
            />
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent className="text-xs">
            <img
              src="https://img.freepik.com/premium-vector/money-hand-cartoon-cash-payments-concept-businessman-hands-takes-exchange-money_221062-38.jpg"
              width={"200"}
              height={200}
              className="hover:shadow-lg rounded-lg ml-4"
            />
            <p>When paying cash, full payment</p> is required before{" "}
            <span className="font-bold">{moment(date.from).format("LL")}</span>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
    );
  ...
  const checkAccount = () => {
    try {
      let existingCart = localStorage.getItem(
        "sb-uoaqelztwfzinfesejcv-auth-token",
      );
      return existingCart;
    } catch (error) {
      return undefined;
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="LED wall, LED wall Rental,
     LED wall,
     Video wall,
     Digital signage,
     LED display,
    ...
    `}
      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        {true != null ? (
          ...
          <div>
            <div>
              <p className="text-xs mb-4 ml-10">To view the price</p>{" "}
            </div>
            <Button
              className="bg-white text-black hover:border  hover:border-blue-500 hover:bg-gray-100 rounded-full"
